    ...
    return (
        <div className="min-h-screen bg-surface-950 flex items-center justify-center p-4">
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                {/* Auth Card */}
                <div className="glass rounded-2xl p-8 border-primary-500/10">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <div className="relative">
                            ...
                            <button
                                ...
                                className="absolute right-3 top-9 text-surface-400 hover:text-surface-200 transition-colors"
                            >
                    ...
                    <div className="flex items-center gap-4 my-6">
                        ...
                        <span className="text-surface-500 text-sm">or continue with</span>
                        <div className="flex-1 h-px bg-surface-700" />
                    </div>
